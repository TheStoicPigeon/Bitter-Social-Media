...
function getProperty($var){
  ...
  if($var == 'key') Return 'lQew39HTF9b5zomM'; 
	if($var == 'password') Return 'EiQqv6Fl4p12mYeMpV7i1SNbd'; 
	if($var == 'shipaccount') Return '510087763';
	if($var == 'billaccount') Return '510087763';
	if($var == 'dutyaccount') Return '510087763'; 
	if($var == 'freightaccount') Return '510087763';  
	if($var == 'trackaccount') Return '510087763'; 
	if($var == 'dutiesaccount') Return '510087763';
	if($var == 'importeraccount') Return '510087763';
	if($var == 'brokeraccount') Return '510087763';
	if($var == 'distributionaccount') Return '510087763';
  ...
  if($var == 'shipdate') Return '2016-04-21';
	...
	if($var == 'trackingnumber') Return '9999';
